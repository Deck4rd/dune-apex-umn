            ...
            if jsonFile[-5:] == ".json":
                ...
                if len(data[dataType])==0:
                    ...
                    for i in range (0,len(data[dataType])):
                        ...
                        inc.display_events(data[dataType][i],evt_title,saveFileName,evt_nr_mismatch,singleChannelDisplay)
